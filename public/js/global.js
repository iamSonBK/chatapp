    ...
    socket.on('loggedInUser', function(users){
        ...
        for(var i = 0; i < users.length; i++){
            if(friend.indexOf(users[i].name) > -1){
                ...
                var userImg = users[i].img;
                console.log(userName);
                
                var list = '<img src='+ userImg + ' class="pull-left img-circle" style="width:50px; height:50px;object-fit:cover; margin-right:10px; border-radius : 100%;" /><p>' +
