    ...
    return {
        ...
        getProfilePage: function(req, res){
            async.parallel([
                ...
                res.render('user/profile', {title: 'ChatApp - Profile', user:req.user, data: result1, chat:result2});
            });
        },
                ...
                function(result, callback){
                    if(req.body.upload === null || req.body.upload === ''){
                        ...
                        },
                        {
                            ...
                            userImage:"https://chattapppp.s3-ap-southeast-1.amazonaws.com/"+result.userImage
                        },
                        {
                            upsert: true
                        }, (err, result) => {
                        ...
                        },
                        {
                            ...
                            gender: req.body.gender,
                            country: req.body.country,
                            userImage: "https://chattapppp.s3-ap-southeast-1.amazonaws.com/"+ req.body.upload
                        },
                        {
                            upsert: true
                        }, (err, result) => {
